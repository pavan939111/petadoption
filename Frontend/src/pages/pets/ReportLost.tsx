        ...
        <Card className="shadow-2xl border-2 border-gray-200 bg-white rounded-2xl">
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <CardContent className="space-y-8 px-8 pb-8">
              ...
              {/* Photos - Full Width */}
              <div className="space-y-2">
                <Label htmlFor="photos" className="text-sm font-semibold">Photos (Optional but helpful)</Label>
            ...
            <div className="px-6 py-6 flex flex-col sm:flex-row gap-3 border-t bg-muted/20">
              <Button
                type="button"
                variant="outline"
                onClick={() => navigate(-1)}
              ...
              <Button 
                ...
                className="flex-1 h-11 bg-blue-500 hover:bg-blue-600 text-white font-semibold"
              >
